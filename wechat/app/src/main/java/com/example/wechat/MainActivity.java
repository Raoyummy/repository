...
//            {"腾讯新闻"," 哈哈哈哈哈哈哈哈哈哈哈" ,"21:36"},
//            {"麦当劳","嗨翻了！今天0元脆汁鸡！速领","17:00"},
//            {"小黑眼圈","[视频通话]","15:07"},
//            {"文件传输助手","[图片]","13:39"},
//            {"库小迪Cotti"," 限时海绵宝宝周边免费送" ,"13:00"},
//            {"订阅号消息"," GS万能墙：请工商同学吃" ,"9:00"},
//            {"微信运动","[应用消息]","昨天"},
//            {"微信运动","[应用消息]","昨天"}
//    };
//    //定义一个map集合存放数据
...
import com.example.wechat.fragment.FragmentFour;
import com.example.wechat.fragment.FragmentOne;
import com.example.wechat.fragment.FragmentThree;
import com.example.wechat.fragment.FragmentTwo;
...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void setTabSelection(int index) {
        ...
        switch (index) {
            case 0:
                ...
                message_image.setImageResource(R.drawable.al_);//修改布局中的图片
                message_text.setTextColor(Color.parseColor("#45C01A"));//修改字体颜色
            ...
            // 以下和firstFragment类同
            case 1:
                news_image.setImageResource(R.drawable.al8);
                news_text.setTextColor(Color.parseColor("#45C01A"));
                ...
                break;
            case 2:
                contacts_image.setImageResource(R.drawable.alb);
                contacts_text.setTextColor(Color.parseColor("#45C01A"));
                ...
                break;
            case 3:
                setting_image.setImageResource(R.drawable.ald);
                setting_text.setTextColor(Color.parseColor("#45C01A"));
    ...
    private void clearSelection() {
        message_image.setImageResource(R.drawable.ala);
        message_text.setTextColor(Color.parseColor("#82858b"));

        contacts_image.setImageResource(R.drawable.al9);
        contacts_text.setTextColor(Color.parseColor("#82858b"));

        news_image.setImageResource(R.drawable.alc);
        news_text.setTextColor(Color.parseColor("#82858b"));

        setting_image.setImageResource(R.drawable.ale);
